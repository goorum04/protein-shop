...
const translations = {
  ca: {
    ...
    assessoria_inc1: "Formulari previ a la trucada per conèixer-te millor, possibles al·lèrgies, intoleràncies i lesions.",
    assessoria_inc2: "Entrenaments adaptats al teu nivell, temps i objectius.",
    assessoria_inc3: "Pla nutricional flexible que encaixa amb la teva vida: receptes ràpides, fàcils i bones.",
    assessoria_inc4: "Seguiment setmanal per WhatsApp i revisions 1:1.",
    assessoria_inc5: "Ajustos constants segons els teus progressos i necessitats.",
    assessoria_inc6: "Suport durant tot el procés. L'acompanyament i la motivació són claus per aconseguir els teus objectius.",
    ...
    machines_hero_tagline: "Més de 15 gimnassos muntats",
  ...
  es: {
    ...
    assessoria_inc1: "Formulario previo a la llamada para conocerte mejor, posibles alergias, intolerancias y lesiones.",
    assessoria_inc2: "Entrenamientos adaptados a tu nivel, tiempo y objetivos.",
    assessoria_inc3: "Plan nutricional flexible que encaja con tu vida: recetas rápidas, fáciles y buenas.",
    assessoria_inc4: "Seguimiento semanal por WhatsApp y revisiones 1:1.",
    assessoria_inc5: "Ajustes constantes según tus progresos y necesidades.",
    assessoria_inc6: "Apoyo durante todo el proceso. El acompañamiento y la motivación son claves para conseguir tus objetivos.",
    assessoria_cta_tag: "🚀 ¡Es tu momento!",
    ...
    machines_hero_tagline: "Más de 15 gimnasios montados",
  ...
  fr: {
    ...
    assessoria_inc1: "Formulaire préalable à l'appel pour mieux vous connaître, allergies, intolérances et blessures.",
    assessoria_inc2: "Entraînements adaptés à votre niveau, temps et objectifs.",
    assessoria_inc3: "Plan nutritionnel flexible qui s'adapte à votre vie : recettes rapides, faciles et bonnes.",
    assessoria_inc4: "Suivi hebdomadaire par WhatsApp et révisions 1:1.",
    assessoria_inc5: "Ajustements constants selon vos progrès et besoins.",
    assessoria_inc6: "Soutien tout au long du processus. L'accompagnement et la motivation sont essentiels.",
    ...
    machines_hero_tagline: "Plus de 15 salles montées",
  ...
  en: {
    ...
    assessoria_inc1: "Pre-call form to get to know you better, possible allergies, intolerances and injuries.",
    assessoria_inc2: "Workouts adapted to your level, time and goals.",
    assessoria_inc3: "Flexible nutrition plan that fits your life: quick, easy and good recipes.",
    assessoria_inc4: "Weekly follow-up via WhatsApp and 1:1 reviews.",
    assessoria_inc5: "Constant adjustments based on your progress and needs.",
    assessoria_inc6: "Support throughout the whole process. Accompaniment and motivation are key to achieving your goals.",
    ...
    machines_hero_tagline: "More than 15 gyms built",
